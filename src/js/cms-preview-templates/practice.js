...
export default class practicePreview extends React.Component {
  render() {
    ...
    const entrypractice = entry.getIn(["data", "practice"]);
    const practice = entrypractice ? entrypractice.toJS() : [];
    
    return <div>
      <Jumbotron image={image} title={entry.getIn(["data", "title"])} />
      <div className="bg-off-white pv4">
        <div className="mw7 center ph3 pt4">
          {practice.map(({text, heading, imageUrl}, i) =>
